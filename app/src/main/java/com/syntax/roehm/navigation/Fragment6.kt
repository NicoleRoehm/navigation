...
import com.syntax.roehm.navigation.databinding.Fragment6Binding
...
class Fragment6 : Fragment() {
    ...
    override fun onCreateView(
        ...
        binding.frag6Frag1.setOnClickListener {
            Navigation.findNavController(view).navigate(R.id.action_fragment6_to_fragment1)
        }
